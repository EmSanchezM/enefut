...
const columns = [
  { id: 'pname', label: 'Documento', minWidth: 170 },
...
const DocumentoTable = () => {
  ...
  return (
    <PageContainer title="Documentos" description="Documentos de Estudiantes">
      {/* breadcrumb */}
      <Breadcrumb title="Listado de Documentos" items={BCrumb} />
      {/* end breadcrumb */}
      <Card>
        <CardContent>
          <TableContainer
